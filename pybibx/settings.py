...
class PyBibXSettings(BaseSettings):
    ...
    providers: tuple[ProviderSettings, ...] = Field(
        default_factory=lambda: (
            ...
            ProviderSettings(provider=ProviderName.MEDLINE, rate_limit_per_second=3.0),
            ...
            ProviderSettings(provider=ProviderName.MEDRXIV, rate_limit_per_second=1.0),
            ProviderSettings(provider=ProviderName.GOOGLE_SCHOLAR_EXPORT),
