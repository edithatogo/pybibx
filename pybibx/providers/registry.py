...
class ProviderEndpoint(StrictSchemaModel):
    ...
    response_format: InputFormat | None = None
...
DEFAULT_PROVIDER_REGISTRY = ProviderRegistry(
    specs=(
        ProviderSpec(
            ...
            endpoints=(
                ProviderEndpoint(name="works", path="/works", response_format=InputFormat.JSON),
                ProviderEndpoint(name="authors", path="/authors", response_format=InputFormat.JSON),
                ProviderEndpoint(name="institutions", path="/institutions", response_format=InputFormat.JSON),
            ),
        ...
        ProviderSpec(
            ...
            supported_output_formats=(OutputFormat.JSONL, OutputFormat.PARQUET),
            endpoints=(ProviderEndpoint(name="works", path="/works", response_format=InputFormat.JSON),),
        ...
        ProviderSpec(
            ...
            supported_output_formats=(OutputFormat.JSONL, OutputFormat.PARQUET),
            endpoints=(
                ProviderEndpoint(name="search", path="/esearch.fcgi", response_format=InputFormat.JSON),
                ProviderEndpoint(name="summary", path="/esummary.fcgi", response_format=InputFormat.JSON),
                ProviderEndpoint(name="fetch", path="/efetch.fcgi", response_format=InputFormat.XML),
            ),
        ...
        ProviderSpec(
            ...
            supported_input_formats=(InputFormat.XML, InputFormat.JSON),
            supported_output_formats=(OutputFormat.JSONL, OutputFormat.PARQUET),
            endpoints=(ProviderEndpoint(name="fetch", path="/efetch.fcgi", response_format=InputFormat.XML),),
        ...
        ProviderSpec(
            ...
            supported_input_formats=(InputFormat.JSON,),
            supported_output_formats=(OutputFormat.JSONL, OutputFormat.PARQUET),
            endpoints=(ProviderEndpoint(name="index", path="/index/v2", response_format=InputFormat.JSON),),
        ...
        ProviderSpec(
            ...
            supported_output_formats=(OutputFormat.JSONL, OutputFormat.PARQUET),
            endpoints=(
                ProviderEndpoint(name="graph-paper", path="/graph/v1/paper", response_format=InputFormat.JSON),
                ProviderEndpoint(name="datasets", path="/datasets/v1", response_format=InputFormat.JSON),
            ),
        ...
        ProviderSpec(
            ...
            supported_output_formats=(OutputFormat.JSONL, OutputFormat.PARQUET),
            endpoints=(
                ProviderEndpoint(name="organizations", path="/organizations", response_format=InputFormat.JSON),
            ),
        ...
        ProviderSpec(
            ...
            supported_output_formats=(OutputFormat.JSONL, OutputFormat.PARQUET),
            endpoints=(ProviderEndpoint(name="record", path="/{orcid}/record", response_format=InputFormat.JSON),),
            fixtures=(_json_fixture(ProviderName.ORCID, "Minimal ORCID public record payload."),),
            version=_version(ProviderName.ORCID, "3.0"),
            terms_note="Use ORCID public API or public data-file records; configure tokens only when required.",
        ),
        ProviderSpec(
            ...
            supported_input_formats=(InputFormat.JSON,),
            supported_output_formats=(OutputFormat.JSONL, OutputFormat.PARQUET),
            endpoints=(ProviderEndpoint(name="doi", path="/{doi}", response_format=InputFormat.JSON),),
        ...
        ProviderSpec(
            ...
            supported_input_formats=(InputFormat.XML, InputFormat.JSON),
            supported_output_formats=(OutputFormat.JSONL, OutputFormat.PARQUET),
            endpoints=(ProviderEndpoint(name="query", path="/query", response_format=InputFormat.XML),),
        ...
        ProviderSpec(
            ...
            supported_input_formats=(InputFormat.JSON,),
            supported_output_formats=(OutputFormat.JSONL, OutputFormat.PARQUET),
            endpoints=(ProviderEndpoint(name="details", path="/details/biorxiv", response_format=InputFormat.JSON),),
        ...
        ProviderSpec(
            ...
            supported_input_formats=(InputFormat.JSON,),
            supported_output_formats=(OutputFormat.JSONL, OutputFormat.PARQUET),
            endpoints=(ProviderEndpoint(name="details", path="/details/medrxiv", response_format=InputFormat.JSON),),
        ...
        ProviderSpec(
            ...
            capabilities=(ProviderCapability.METADATA_SEARCH, ProviderCapability.CITATION_INDEX),
            supported_input_formats=(InputFormat.CSV, InputFormat.TSV, InputFormat.RIS, InputFormat.BIBTEX),
            supported_output_formats=(OutputFormat.JSONL, OutputFormat.PARQUET),
            fixtures=(
                ProviderFixture(
