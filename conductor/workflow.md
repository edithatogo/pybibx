...
- In this non-TTY Codex session, Cline/DeepSeek is considered blocked because `cline config --json` requires an interactive TTY; use Codex sub-agents as the parallel worker fallback.
